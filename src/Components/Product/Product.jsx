...
export default function Product({ product, index }) {
    ...
    // This deduplicates requests across multiple Product components.
    ...
    const handleWishlistClick = async () => {
        ...
        // Invalidate wishlist query to trigger a background refetch and update UI across all components
