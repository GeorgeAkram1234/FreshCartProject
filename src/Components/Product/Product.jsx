...
export default function Product({ product, index }) {
    ...
    // All Product components will share the same cache entry, eliminating N+1 API calls
    ...
    const handleWishlistToggle = async () => {
        ...
        // Invalidate the wishlist query to refetch and update all Product components
