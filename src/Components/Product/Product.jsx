...
export default function Product({ product }) {
    ...
    /**
     * BOLT OPTIMIZATION:
     * Replaced per-component useEffect fetching with a shared useQuery.
     * This deduplicates network requests for the wishlist, reducing O(N) calls to O(1).
     * staleTime is set to 10 minutes to maintain high performance across route transitions.
     */
    ...
    const handleWishlistClick = async () => {
        ...
        // Invalidate wishlist query to sync state across all product components
