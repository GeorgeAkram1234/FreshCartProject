...
export default function WishList() {
  ...
  async function productRemove(productId) {
    ...
    // After removing a product, invalidate the wishlist query to refetch
                ...
                <div key={product._id} className="flex flex-col shadow-xl p-3">
                  <div className="relative">
                    <Link to={"/productDetails/" + product._id}>
                      <img
                        className="rounded-lg lg:block w-full"
                  ...
                  <div className="flex flex-col justify-start items-start mt-0">
                    ...
                    <div className="flex justify-between flex-col lg:flex-row items-center mt-4 w-full space-y-1 lg:space-y-0 lg:space-x-1 xl:space-x-8">
