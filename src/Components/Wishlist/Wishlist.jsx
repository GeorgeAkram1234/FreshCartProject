...
export default function WishList() {
  ...
  // PERFORMANCE: Using shared React Query cache for consistency with Product components
  // and to eliminate redundant API calls across the application.
              ...
              <div key={product._id} className="flex flex-col shadow-xl p-3">
                <div className="relative">
                  <Link to={"/productDetails/" + product._id}>
                    {/* PERFORMANCE: Added loading="lazy" to improve Largest Contentful Paint (LCP) */}
