              ...
              <div key={product._id || product.id} className="flex flex-col shadow-xl p-3">
                <div className="relative">
                  <Link to={"/productDetails/" + product._id}>
                    <img className=" rounded-lg lg:block" src={product.imageCover} alt={product.title || product.name} />
                  </Link>
                  <button
                    aria-label="remove"
                ...
                <div className="mt-1 flex justify-between items-center ">
                  <div className="flex justify-center items-center">
                    <p className="tracking-tight text-2xl font-semibold leading-6 text-gray-600 dark:text-white">{product.title || product.name}</p>
                  </div>
                ...
                <div className="flex flex-col justify-start items-start mt-0">
                  ...
                  <div className="mt-1">
                    <p className="tracking-tight text-base font-medium leading-4 text-gray-600 dark:text-white">{product.title || product.name}</p>
                  </div>
                  <div className="mt-1">
