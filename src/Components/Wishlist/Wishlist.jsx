...
export default function WishList() {
  ...
  const { wishlistData, isLoading, removeFromWishlist } = useContext(WishlistContext);
    ...
    <>
      {isLoading ? <LoadingScreen /> : <div className="mx-auto container px-4 md:px-6 2xl:px-0 py-12 flex flex-col">
        <div className="flex flex-col justify-start items-start">
          ...
          <div className="mt-4">
            <p className="text-2xl tracking-tight leading-6 text-gray-600 dark:text-white">{wishlistData.length} items</p>
          </div>
