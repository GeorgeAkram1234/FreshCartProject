...
export default function WishList() {
  ...
  async function productRemove(productId) {
    ...
    // Invalidate the query to update the wishlist view and any product cards in other routes
              ...
              <div key={product._id} className="flex flex-col shadow-xl p-3">
                ...
                <div className="flex flex-col justify-start items-start mt-0">
                  ...
                  <div className="flex justify-between flex-col lg:flex-row items-center mt-4  space-y-1 lg:space-y-0 lg:space-x-1 xl:space-x-8 w-full">
                    ...
                    <div className="w-full">
                    <button className=" rounded-lg p-3 focus:outline-none focus:ring-green-600 focus:ring-offset-2 focus:ring-2 text-white w-full tracking-tight py-2 text-lg leading-4 hover:bg-green-700 bg-green-600 border border-green-600 dark:bg-white dark:text-green-900 dark:hover:bg-green-700 dark:hover:text-white"
