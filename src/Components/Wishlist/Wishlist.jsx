...
export default function WishList() {
  ...
  /**
   * BOLT OPTIMIZATION:
   * Refactored to use the same React Query key as the Product component.
   * This ensures that wishlist data is consistent across the app and leverages
   * cached data when navigating between the Home and Wishlist pages.
   */
  ...
  async function productRemove(productId) {
    ...
    // Invalidate wishlist query to refresh the list and update all components
