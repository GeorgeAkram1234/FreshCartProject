...
export default function WishList() {
  ...
  // Use the same 'wishlist' query key as the Product component for cache consistency.
  ...
  const removeMutation = useMutation({
    ...
    onSuccess: () => {
      // Invalidate and refetch wishlist to keep all components in sync
            ...
            {wishlist.map(product => (
              <div key={product._id || product.id} className="flex flex-col shadow-xl p-3">
                ...
                <div className="flex flex-col justify-start items-start mt-0">
                  {/* Keep additional fields for UI consistency if they exist */}
                  {product.code && (
                    <div>
