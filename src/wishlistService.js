...
export async function addProductToWishlist(productId, userToken) {
    try {
        ...
        return data; // Return data for React Query invalidation
...
export async function getWishlist(userToken) {
    ...
    try {
        ...
        return data.data; // The products array is in data.data
    } catch (error) {
...
// Deprecated: Use isProductInWishlistArray with cached data instead
...
// Helper function to check if a product is in a wishlist array
