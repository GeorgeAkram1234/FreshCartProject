...
// Legacy function to check if a product is in the wishlist (async)
// Note: Prefer using getWishlist + isProductInWishlistArray with React Query for better performance
