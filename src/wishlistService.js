...
// DEPRECATED: Use React Query and isProductInWishlistArray instead for better performance.
// Function to check if a product is in the wishlist (triggers an API call)
...
// Utility to check if a product is in a wishlist array (no API call)
