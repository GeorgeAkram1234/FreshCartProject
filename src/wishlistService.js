...
/**
 * Check if a product is in the wishlist array
...
/**
 * @deprecated Use getWishlist and isProductInWishlistArray instead for better performance
 * Function to check if a product is in the wishlist by making an API call
 */
