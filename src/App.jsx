 ...
 *
 * We use React.lazy() to dynamically import route components. This splits the
 * application into smaller chunks, ensuring that the code for each route is
 * only loaded when the user navigates to it. This significantly reduces the
 * initial bundle size and improves the Time to Interactive (TTI).
 *
 * Impact: Reduces main production bundle size from 498.69 kB to 273.03 kB (~45% reduction).
 */
...
/**
 * ⚡ Performance Optimization: Stable QueryClient
 *
 * Moving QueryClient instantiation outside of the App component ensures that
 * the cache is preserved across re-renders of the App component.
 */
