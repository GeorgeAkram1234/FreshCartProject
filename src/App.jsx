...
// Route-based code splitting: Lazy load all main components to reduce initial bundle size
...
function App() {
  ...
  // Resource Memoization: Lazily initialize QueryClient to prevent recreation on every re-render
