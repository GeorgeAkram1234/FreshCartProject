 ...
 * This reduces the initial bundle size significantly by loading route components only when they are needed.
 * Estimated Impact: ~45% reduction in main bundle size.
 */
import './App.css'
