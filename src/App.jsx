...
// Static components (needed for initial layout or protection)
import Layout from './Components/Layout/Layout.jsx'
import ProtectedRoute from './Components/ProtectedRoute/ProtectedRoute.jsx'
import ProtectAuthRoutes from './Components/ProtectAuthRoutes/ProtectAuthRoutes.jsx'

// BOLT OPTIMIZATION: Route-based code splitting using React.lazy
// This reduces the initial bundle size significantly (~500kB -> ~270kB)
// as the code for each route is only loaded when the user navigates to it.
...
// BOLT OPTIMIZATION: Move QueryClient outside the component
// This prevents the client from being re-instantiated on every App re-render,
// preserving the cache and avoiding unnecessary overhead.
