...
function App() {
  // Using useState to initialize QueryClient prevents it from being recreated on every re-render,
  // preserving the React Query cache.
  const [queryClient] = useState(() => new QueryClient({
    defaultOptions: {
      queries: {
        staleTime: 10 * 60 * 1000, // 10 minutes - adjust based on app needs
      },
    },
  }))
